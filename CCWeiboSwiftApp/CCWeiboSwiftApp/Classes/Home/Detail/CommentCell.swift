...
class CommentCell: UITableViewCell {
    ...
    var comment: CommentModel? {
        didSet {
            let url = URL(string: comment!.user?.avatarLarge ?? "")
            ...
            commentLabel.attributedText = EmoticonManager.emoticonMutableAttributedString(string: comment!.text ?? "", font: commentLabel.font)
        }
    }
